...
fn spawn_division_tooltip(commands: &mut Commands, font: Handle<Font>) {
    commands
        ...
        .with_children(|tooltip| {
            ...
            tooltip.spawn((
                Text::new("Когда жизнеспособность достигает этой отметки, клетка может дать потомство."),
                TextFont {
                    font,
                    font_size: 14.0,
                    ..default()
...
fn spawn_pause_menu(commands: &mut Commands, font: Handle<Font>) {
    commands
        ...
        .with_children(|menu| {
            ...
            spawn_pause_menu_button(menu, font.clone(), PauseMenuAction::MainMenu, "Главное меню");
